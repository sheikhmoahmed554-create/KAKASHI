...
mcMaEmaV = ta.ema(close, mcMaLen)
mcMaSmaV = ta.sma(close, mcMaLen)
mcMa = mcMaType == "EMA" ? mcMaEmaV : mcMaSmaV
...
mcBrtConfirm = int(math.max(1, mcBrtPeriod / mcBrtConfirmDiv))
...
var bool mcQqeAbovePrev = false
mcQqeBuy = mcQqeAbove and not mcQqeAbovePrev
mcQqeSell = not mcQqeAbove and mcQqeAbovePrev
mcQqeAbovePrev := mcQqeAbove
...
var bool mcSqzOffPrev = false
mcSqzRelBuy = mcSqzOff and not mcSqzOffPrev and mcSqzMom >= mcSqzSig
mcSqzRelSell = mcSqzOff and not mcSqzOffPrev and mcSqzMom < mcSqzSig
mcSqzOffPrev := mcSqzOff
